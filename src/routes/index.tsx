...
import {
  useRouter, useDocumentTitle, useProxy,
  Drawer, Icon, Layout, Menu, useThemeToggle
} from '../../lib'
      ...
      <Layout.Header className='app-header'>
        <div>
          {windowSize.width >= rwd.md ? (
            ...
            <Icon className='cursor-pointer' onClick={() => state.menuOpen = true}>Menu</Icon>
          )}
          <Drawer
        ...
        <div>
          ...
          <Icon button onClick={toggleTheme}>
