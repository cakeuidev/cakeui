...
export default () => {
  return (
    ...
    props: `
type ProgressProps = React.JSX.IntrinsicElements['svg'] & {
...
type DataTableProps = React.JSX.IntrinsicElements['div'] & {
  ...
  onSelect?: (selection: DataTableTarget) => void
...
> & {
  ...
  onSubmit?: (event: React.FormEvent<HTMLFormElement>, values: FormValues) => void
...
> & {
  ...
  value?: boolean
  onChange?: (event: CustomEvent<{ value: boolean }>) => void
}
    `
  },
  Slider: {
...
> & {
  ...
  onChange?: (event: CustomEvent<{ value: dayjs.Dayjs | null }>) => void
  open?: boolean
  onChangeOpen?: (open: boolean) => void
