...
const flat = (routes: Route[], parentPath: string = '', components: Component[] = []) => {
...
export function Router(props: RouterProps) {
  ...
  const base = useMemo(() => {
    return convert(staticRouterContext ? staticRouterContext.basename : basename)
  }, [staticRouterContext?.basename, basename])
  const getPathname = useFunction((pathname: string) => {
  ...
  const [pathname, setPathname] = useState(() => {
    return getPathname(staticRouterContext ? staticRouterContext.url : location.pathname)
  })
