...
export type DataTableProps = React.JSX.IntrinsicElements['div'] & {
  ...
  onChangeSelection?: (selection: DataTableTarget) => void
...
function DataTable(props: DataTableProps) {
  ...
  const [selection, setSelection] = useStateListner(propsSelection, onChangeSelection)
  const [hover, setHover] = useStateListner<DataTableTarget>({}, onHover)
        ...
        {[lCols, mCols, rCols].map((cols, i) => !!cols.length && (
          ...
          >
            <Table>
              ...
              <tbody style={rendering ? undefined : { height: dataHeight }} translate='no'>
                  ...
                  <tr>
                    {cols.map(({ field, width }) => (
                      <td
                        ...
                        align={field.align}
                        className={cls({
                          'ui-data-table-selected': field.key === selection?.key && selection.id === undefined
                        })}
                      >
                        <div style={{ width }}>
                          {footer(field)}
