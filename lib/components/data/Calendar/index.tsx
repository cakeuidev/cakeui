      ...
      <div className='ui-calendar-title'>
        {arrows && (
          <Icon
            button
            className={cls({
              'ui-calendar-disabled': month.isSame(minDate, 'month') || month.isBefore(minDate, 'month')
            })}
        ...
        <span className='ui-calendar-year-month'>
          ...
          <span className='ui-calendar-month'>
            <Select
              ...
              onChange={(e) => setMonth(year.add(Number(e.detail.value), 'month'))}
        ...
        {arrows && (
          <Icon
            button
            className={cls({
              'ui-calendar-disabled': month.isSame(maxDate, 'month') || month.isAfter(maxDate, 'month')
            })}
            onClick={() => onClickArrow(1)}
          >
        ...
        {days.map((d) => (
          <span
            ...
            className={cls({
              ...
              'ui-calendar-disabled': d.isBefore(minDate, 'day') || d.isAfter(maxDate, 'day') || disabledDate?.(d)
            })}
