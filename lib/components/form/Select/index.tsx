      ...
      <div className={cls({ 'ui-select-tags': activeOptions.length })}>
        ...
        {searchable ? (
          <input
            ...
            placeholder={(multiple ? undefined : activeOption?.label) ?? rest.placeholder}
            onBlur={() => {
              if (stayOpen.current) {
          ...
          multiple ? undefined : activeOption?.label
        )}
      </div>
      {after ?? (
        <>
            ...
            >
              {searchOptions.map((option, i) => (
                <div
                  key={option.value}
                  className={cls({
                    'ui-select-hover': i === index && !option.disabled,
                    'ui-select-active': multiple ? v?.includes(option.value) : option.value === v,
                    'ui-select-disabled': option.disabled
                  })}
                  onMouseMove={() => {
