...
function Dropdown(props: DropdownProps) {
  ...
  useOutsideEvent('click', (e) => {
    ...
    if (trigger === 'click' && !parent.current?.contains(el)) {
      api.close()
    }
  }, el)
  useEventListener('resize', render)
  useEventListener('scroll', render, null, true)
...
function DropdownContent(props: DropdownContentProps) {
  const { state, el, observer, onMouseEnter, onMouseLeave } = use(DropdownContext)!
