...
type LayoutSiderProps = React.ComponentPropsWithRef<'aside'>
    `},ThemeToggle:{examples:[{name:"Example",Component:()=>{const[r,o]=Jt();return e.jsx(P,{variant:"icon",onClick:o,children:e.jsx(A,{children:r==="light"?"dark_mode":"light_mode"})})},code:`
...
type ThemeToggleFunction = () => void
    `},Progress:{examples:[{name:"Example",Component:()=>e.jsx(Yt,{value:30}),code:`
...
type ProgressProps = React.ComponentPropsWithRef<'svg'> & {
  ...
  color?: string       // default: '#2b7fff'
  text?: string
}
    `},ContextMenu:{examples:[{name:"Example",Component:()=>e.jsx(Qt,{render:"Content",children:e.jsx(P,{children:"Right click me"})}),code:`
...
type DrawerFooterProps = React.ComponentPropsWithRef<'div'>
    `},Dropdown:{examples:[{name:"Example",Component:()=>e.jsx(qt,{render:"Content",children:e.jsx(P,{children:"Hover me"})}),code:`
...
export default () => {
  ...
  return (
    ...
    />
        ...
        `}],props:`
type MenuProps = React.ComponentPropsWithRef<'div'> & {
  menus?: MenuItem[]
  openKeys?: React.Key[]
  onOpenKeysChange?: (keys: React.Key[]) => void
  type?: 'horizontal' | 'vertical' // default: 'horizontal'
  inline?: boolean                 // default: false
  indent?: number                  // default: 16
}
type MenuItem<T extends React.ElementType = any> = React.ComponentPropsWithRef<T> & {
  key: React.Key
...
type MessageType = '' | 'info' | 'success' | 'error' | 'warning' | 'loading'
    `},Overlay:{examples:[{name:"Example",Component:()=>{const[r,o]=i.useState(!1);return e.jsxs(e.Fragment,{children:[e.jsx(P,{onClick:()=>o(!0),children:"Open Overlay"}),e.jsx(Xt,{open:r,onClick:()=>o(!1)})]})},code:`
import { useState } from 'react'
...
type PopoverProps =React.ComponentPropsWithRef<'div'> & {
  ...
  offset?: number                               // default: 4
    ...
    `},Calendar:{examples:[{name:"Example",Component:()=>e.jsx(Kt,{}),code:`
...
type InputPasswordProps = InputProps & {
  visibilityToggle?: boolean // default: true
    ...
    `},InputNumber:{examples:[{name:"Example",Component:()=>e.jsx(Ut,{}),code:`
...
type CheckboxOption = {
  ...
  disabled?: boolean
    ...
    `},Switch:{examples:[{name:"Example",Component:()=>e.jsx(Gt,{}),code:`
...
> & {
  ...
  onValueChange?: (value: boolean) => void
    ...
    `},Slider:{examples:[{name:"Example",Component:()=>e.jsx(zt,{}),code:`
...
> & {
  ...
  onValueChange?: (value: string) => void
    ...
    `},Upload:{examples:[{name:"Example",Component:()=>e.jsx(At,{}),code:`
